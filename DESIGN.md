...
- **Full expression — the home page** (`/`, Persuade mode): the hero, the crease-line tessellation texture, the split-screen and zig-zag layout, the one authored entrance animation.
