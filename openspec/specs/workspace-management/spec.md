...
(e.g. per person or company). A workspace has a name, a URL-safe slug
derived from that name, an owner email (for internal/administrative
contact only), and a hashed password.
