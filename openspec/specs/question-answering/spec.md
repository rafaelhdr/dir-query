...
The question-answering capability lets a user ask a natural-language question and get an answer generated from the content of indexed documents, using retrieval over the persisted document index and the MiniMax LLM.
